...
export default function Home() {
    ...
    const getData = async () => {
        const result = await axios.get("http://localhost:3000/api/digimon");
        setData(result.data);
    };
                ...
                <Button
                    onClick={() => {
                        setDigimon(
                            data.find(
                                (value) =>
                                    value.name === textFieldRef.current?.value
                            )
                        );
                    }}
                >
                ...
                <>
                    <Row justifyContent="center">
                        <CardContainer>
                            ...
                            <Row justifyContent="center">
                                <ProfileImage
                                    source={`/images/${digimon?.name.toLowerCase()}.png`}
                                />
                            </Row>
